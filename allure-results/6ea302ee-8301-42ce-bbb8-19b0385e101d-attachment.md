...
Call log:
  - waiting for locator('.inventory-item').filter({ hasText: 'Sauce Labs Backpack' }).locator(getByRole('button', { name: 'Add to cart' }))
...
> 14 |         await this.productItem.locator(this.addToCart).click();
     |                                                        ^ Error: locator.click: Test timeout of 30000ms exceeded.
